...
import { Queue, Node as Node$1 } from '@garfish/utils';
...
declare class App {
    ...
    private deferNodeMap;
    private resolveAsyncProvider;
    ...
    awaitAsyncProviderRegistration(): Promise<interfaces.Provider | ((...args: any[]) => interfaces.Provider) | undefined>;
...
declare function appLifecycle(): PluginSystem<{
    ...
    customRender: SyncWaterfallHook<{
        node: Node$1;
        parent: Element;
        app: interfaces.App;
