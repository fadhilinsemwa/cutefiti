...
const generateContentHash = (content) => {
  return (0, import_crypto.createHash)("md5").update(content).digest("hex").slice(0, 8);
};
class RouterPlugin {
  ...
  apply(compiler) {
    ...
    compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation) => {
      ...
      compilation.hooks.processAssets.tapPromise({
        ...
        const prevManifestAsset = compilation.getAsset(import_utils.ROUTE_MANIFEST_FILE);
        ...
        for (let i = 0; i < entryChunkFiles.length; i++) {
          ...
          const injectedContent = `
            ;(function(){
              window.${import_constants.ROUTE_MANIFEST} = ${JSON.stringify(manifest2, (k, v) => {
