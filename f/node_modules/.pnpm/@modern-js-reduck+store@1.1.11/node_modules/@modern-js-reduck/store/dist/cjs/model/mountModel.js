...
const _memoize = require("../utils/memoize");
...
const mountModel = (context, model) => {
  ...
  let modelDesc = (0, _misc.getModelInitializer)(model)(context, {
...
const createReducer = (context, flattenedActions, initialState, computed) => {
  ...
  const depModels = (0, _misc.getComputedDepModels)(computed);
  ...
  return (state = initialState, reduxAction) => {
    ...
    if (computedDescriptors && (0, _misc.getStateType)(newState) !== _misc.StateType.Object) {
...
const generateComputedSelector = (name, computed, useModel) => {
  ...
  const _selector = (fn, ...args) => {
    ...
    if (typeof result === "function") {
      return (0, _memoize.memorize)((...args2) => {
        return result(...args2);
      });
    } else {
      return result;
  ...
  if (typeof computed === "function") {
    ...
    if (!depModels.every((m) => (0, _misc.isModel)(m)) || typeof userSelector !== "function") {
  ...
  return (0, _memoize.memorize)(selector);
};
