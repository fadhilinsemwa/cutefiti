...
declare const PLUGIN_REM_NAME = "rsbuild:rem";
declare const pluginRem: (userOptions?: PluginRemOptions) => RsbuildPlugin;

export { PLUGIN_REM_NAME, type PluginRemOptions, pluginRem };
