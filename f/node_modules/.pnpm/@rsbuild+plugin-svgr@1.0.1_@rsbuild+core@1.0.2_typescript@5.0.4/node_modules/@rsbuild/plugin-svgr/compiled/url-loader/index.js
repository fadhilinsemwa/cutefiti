(() => {
  var __webpack_modules__ = {
    ...
    588: (__unused_webpack_module, exports, __nccwpck_require__) => {
       ...
       * MIT Licensed
       */ var db = __nccwpck_require__(182);
    ...
    842: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      const loader = __nccwpck_require__(926);
      module.exports = loader.default;
      module.exports.raw = loader.raw;
    },
    926: (__unused_webpack_module, exports, __nccwpck_require__) => {
      "use strict";
      ...
      var _options = _interopRequireDefault(__nccwpck_require__(339));
      ...
      function getMimetype(mimetype, resourcePath) {
        if (typeof mimetype === "boolean") {
          if (mimetype) {
            const resolvedMimeType = _mimeTypes.default.contentType(
              _path.default.extname(resourcePath),
            );
            if (!resolvedMimeType) {
              return "";
            }
      ...
      function loader(content) {
        ...
        const { loader: fallbackLoader, options: fallbackOptions } = (0,
        _normalizeFallback.default)(options.fallback, options);
    ...
    442: (__unused_webpack_module, exports, __nccwpck_require__) => {
      ...
      var _loaderUtils = _interopRequireDefault(__nccwpck_require__(429));
      function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { default: obj };
      }
