...
`;
  ...
  function transformUrl(resolvePath, curPath) {
    if (curPath.startsWith("http") || curPath.startsWith("//") || curPath.startsWith("blob:")) {
      return curPath;
    }
...
` : ""}`;
    ...
    const options = {
      ...
      afterLoad(appInfo, appInstance) {
        ...
        rewriteAppAndSandbox(Garfish2, appInstance, new Sandbox({
          ...
          excludeAssetFilter: (_i = appInfo.sandbox) == null ? void 0 : _i.excludeAssetFilter,
  ...
  function createContext() {
    ...
    if (fresh) {
      if (typeof process !== "undefined" && process.env && process.env.NODE_ENV ? process.env.NODE_ENV !== "production" : false) {
        if (window["Garfish"].version !== "1.19.2") {
